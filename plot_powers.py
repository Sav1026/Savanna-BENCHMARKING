...
files = {
    ...
    "LLaVA-7B": "benchmark_results_YESNOllava_7b.csv",
    "LLaVA-Llama3 Latest": "benchmark_results_YESNOllava-llama3_latest.csv",
    "Qwen2.5VL-3B": "benchmark_results_YESNOqwen2.5vl_3b.csv"
}
...
for col in power_columns:
    ...
    for ax, (label, filename) in zip(axes, files.items()):
        ...
        if col == "avg_tot_w":
            ...
            ax.axhline(median_val, color="red", linestyle="--", linewidth=2, label=f"Median = {median_val:.2f} W")
    ...
    # Add shared labels
    fig.suptitle(f"Benchmark Comparison for Questions of Type 'YES/NO': {col}", fontsize=16, weight="bold")
